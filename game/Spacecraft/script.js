...
(!(function (t) {
  ...
  class e {
    ...
    set(t, s, i) {
      return t instanceof e ? ((this.x = t.x), (this.y = t.y), (this.z = t.z), this) : ("number" == typeof t && (this.x = t), "number" == typeof s && (this.y = s), "number" == typeof i && (this.z = i), this);
    }
    max() {
    ...
    cross(t) {
      let e = this.x,
        ...
        r = t.y,
        a = t.z;
      return ((this.x = s * a - i * r), (this.y = i * n - e * a), (this.z = e * r - s * n), this);
    }
    length() {
      return Math.sqrt(this.x * this.x + this.y * this.y + this.z * this.z);
    }
    scale(t) {
      return ((this.x *= t instanceof e ? t.x : t), (this.y *= t instanceof e ? t.y : t), (this.z *= t instanceof e ? t.z : t), this);
    }
    normalize() {
      var t = this.length();
  ...
  class s {
    ...
    transpose() {
      const t = this.data,
        ...
        s = t[2],
        i = t[5];
      return ((t[1] = t[3]), (t[2] = t[6]), (t[3] = e), (t[5] = t[7]), (t[6] = s), (t[7] = i), this);
    }
  }
  t.Mat3 = s;
  class i {
    ...
    multiply(t) {
      const e = this.data,
        ...
        R = t[14],
        N = t[15];
      return ((this.data = [s * x + i * b + n * C + r * M, s * w + i * k + n * A + r * F, s * y + i * S + n * z + r * R, s * T + i * E + n * D + r * N, a * x + o * b + h * C + c * M, a * w + o * k + h * A + c * F, a * y + o * S + h * z + c * R, a * T + o * E + h * D + c * N, l * x + u * b + m * C + d * M, l * w + u * k + m * A + d * F, l * y + u * S + m * z + d * R, l * T + u * E + m * D + d * N, f * x + p * b + g * C + v * M, f * w + p * k + g * A + v * F, f * y + p * S + g * z + v * R, f * T + p * E + g * D + v * N]), this);
    }
    scale(t) {
  ...
  class r {
    constructor(t = []) {
      ((this.translate = new e(t[0] || 0, t[1] || 0, t[2] || 0)), (this.rotate = new e(t[3] || 0, t[4] || 0, t[5] || 0)), (this.scale = new e(t[6] || 1, t[7] || 1, t[8] || 1)));
    }
    matrix(e) {
      return ((e = e || new i()).scale(this.scale).rotate(this.rotate.clone().scale(t.RAD_SCALE)).translate(this.translate), this.parent ? this.parent.matrix(e) : e);
    }
  }
  t.Transform = r;
  t.Camera = class {
    constructor(t = 1, s = 45, i = 0.1, n = 100) {
      ((this.rotate = new e()), (this.position = new e()), (this.fov = s), (this.aspect = t), (this.near = i), (this.far = n));
    }
    transform(t) {
  ...
  t.Mesh = class {
    ...
    createFaces(t, e, s) {
      ...
      let n;
      for (let r = 1; r < e; ++r) {
        ((n = r * s + 2), i.push(new o(t[0], t[n], t[n - s])), i.push(new o(t[1], t[n - 1], t[n + s - 1])));
        for (let e = 0; e < s - 1; e++) {
          let r = n + e;
          (i.push(new o(t[r + 1], t[r - s], t[r])), i.push(new o(t[r - s + 1], t[r - s], t[r + 1])));
        }
      }
      (i.push(new o(t[0], t[2], t[n])), i.push(new o(t[1], t[n + s - 1], t[s + 1])));
      for (let e = 0; e < s - 1; e++) {
        let s = n + e;
        (i.push(new o(t[e + 3], t[s], t[e + 2])), i.push(new o(t[s + 1], t[s], t[e + 3])));
      }
      return i;
    }
  };
  t.Item = class {
    constructor(t, e, s) {
      ((this.childs = []), (this.active = !0), (this.stroke = 0), (this.mesh = t), (this.color = e), (this.transform = new r(s)));
    }
    add(t) {
  ...
  t.Shader = class {
    constructor(t, e, s) {
      ((this.attribs = {}), (this.location = {}), (this.gl = t), (this.program = t.createProgram()), (this.indices = t.createBuffer()));
    ...
    attrib(t, e, s) {
      ...
      return (i.bindBuffer(i.ARRAY_BUFFER, e), i.enableVertexAttribArray(n), i.vertexAttribPointer(n, s, i.FLOAT, !1, 0, 0), this);
    }
    uniform(t, e) {
      const s = this.gl;
  ...
  (function (t) {
    ...
    const e = 44100,
      s = { c: 0, db: 1, d: 2, eb: 3, e: 4, f: 5, gb: 6, g: 7, ab: 8, a: 9, bb: 10, b: 11 },
      i = [],
      n = new AudioContext(),
    ...
    t.Sound = class {
      ...
      async render(t, s, i) {
        ...
        if (
          ...
          (e.connect(r), e.detune.setValueCurveAtTime(h, 0, i), (t.buffer = o), (t.loop = !0), t.connect(e), t.start());
        } else {
          let t = n.createOscillator();
          ((t.type = this.type), t.frequency.setValueCurveAtTime(h, 0, i), t.connect(r), t.start(), t.stop(i));
        }
        await n.startRendering();
      }
    };
    function c(t) {
      return (t in r || ((r[t] = n.createGain()), r[t].connect(n.destination)), r[t]);
    }
    ((t.Channel = class {
      constructor(t, e, n) {
        ...
        if (r.length > 1) {
          e = "";
          for (let t = 0; t < r.length; t++) e += t % 2 ? ("," + r[t - 1]).repeat(parseInt(r[t]) - 1) : (e ? "," : "") + r[t];
        }
        e.split(",").forEach((t) => {
          let e = t.match(/^(\d+)/),
            r = t.match(/([a-z]+\d+)/g);
      ...
      play(t) {
        ...
        for (let e = 0; e < this.size; e++) ((n[e] = t.createOscillator()), (n[e].type = s.type), n[e].connect(i));
        (this.data.forEach((t) => {
      ...
      (t.play = function (t, e = !1, s = "master") {
        if (t in a) {
          ...
          return (e && (i.loop = !0), (i.buffer = a[t]), i.connect(c(s)), i.start(), i);
        }
        return null;
      }));
  })(SFX || (SFX = {})),
    ...
    t.Enemy = class extends T3D.Item {
      ...
      intersect(e) {
        if (this.active && !this.explode && !e.explode && this.collider.intersect(e.collider)) {
          if (e.speedTime) return ((this.explode = 7), void t.Event.trigger("hit", e));
  ...
  (function (t) {
    t.Hero = class extends T3D.Item {
      init(e = !0) {
        ...
        (s.translate.set(0, 0, 0), s.rotate.set(0, 0, 90), s.scale.set(1, 1, 1), (this.color = t.COLOR.WHITE), (this.active = !0), (this.transform = s), (this.collider = new T3D.Sphere(s)), (this.tokenCollider = new T3D.Sphere(s)), (this.x = 0), (this.rad = 0.4), (this.acc = -0.015), (this.speed = new T3D.Vec3(0, 0, 0.1)), (this.speedTime = 0), (this.scale = 0.8), (this.scaleTime = 0), (this.magnet = new T3D.Vec3(5, 5, 5)), (this.magnetTime = 0), (this.explode = 0), (this.stroke = 0), e && (this.distance = 0));
      }
      left() {
      ...
      update() {
        let e = this.transform.translate,
          s = this.scale,
          i = this.transform.rotate,
          n = (this.speedTime ? 0.13 : 0.08) + Math.min(this.distance / 15e3, 0.04);
        ((this.speed.z += ((this.active ? n : 0) - this.speed.z) / 20), (this.speedTime -= this.speedTime > 0 ? 1 : 0), (this.color = this.magnetTime > 100 || this.magnetTime % 20 > 10 ? t.COLOR.PINK : t.COLOR.WHITE), (this.scale += ((this.scaleTime ? 0.5 : 0.7) - this.scale) / 5), (this.scaleTime -= this.scaleTime > 0 ? 1 : 0), (this.magnetTime -= this.magnetTime > 0 ? 1 : 0), (this.tokenCollider.scale = this.magnetTime ? this.magnet : this.transform.scale), (this.stroke += (this.explode - this.stroke) / 25), (this.active = e.y > -10 && this.stroke < 6), this.active && !this.stroke && ((this.acc -= this.acc > -0.012 ? 0.003 : 0), (i.z = 90 + 25 * (e.x - this.x)), (i.y = (i.y + 100 * this.speed.z) % 360), (this.speed.y += this.acc), this.speed.y < -0.25 && (this.speed.y = -0.25), (e.x += (this.x - e.x) / 7), (e.y += this.speed.y), (e.z -= e.z / 30), this.transform.scale.set(s, s, s)));
      }
      preview() {
  ...
  (function (t) {
    t.Map = class {
      ...
      update() {
        let e = !1;
        if ((++this.step > this.steps && ((e = !0), (this.step = 0), this.min + this.length < this.config.length - 1 && this.min++), --this.count > 0)) return e;
        if (!this.data.length) {
    ...
    t.Menu = class {
      constructor() {
        ...
        ((this.body = t.$("body")),
          ...
          (this.shop = !0),
          (this.active = !0),
          (this.storage = s && "object" == typeof s && "shop" in s ? s : { score: 0, token: 0, level: 0, shop: [0] }),
          (this.selected = 0),
          (this.heroes = [
        ...
        (t.on(t.$("#ok"), "click", () => {
          ...
          t.on(this.sfxBtn, "click", () => {
            ...
            try {
              switch (t.className) {
                case "no":
                  ((this.volume = 0.3), e.gain.setValueAtTime(this.volume, i), s.gain.setValueAtTime(1, i), (t.className = ""));
                  break;
                case "sfx":
      ...
      play() {
        "PLAY" == this.btn.textContent ? ((this.stats = {}), t.Event.trigger("start")) : "" == this.btn.className && ((this.storage.token -= this.heroes[this.selected].price), this.storage.shop.push(this.selected), this.store(), this.hero());
      }
      hero() {
      ...
      mission(t = !1) {
        ...
        return (
          this.tasks.forEach((s, i) => {
            ...
            ((n.textContent = s.toString()), (n.className = s.done ? "done" : ""), (e = e && s.done));
          }),
      ...
      score(t) {
        ...
        ((i.item(0).textContent = h + ""), (i.item(1).textContent = "₮ " + o + " x 10"), (i.item(2).textContent = a + " x 25"), (i.item(3).textContent = n + " x 50"), (i.item(4).textContent = r + " x 100"), (i.item(5).textContent = c + " x 500"), (h += 500 * c + 100 * r + 50 * n + 25 * a + 10 * o), (i.item(6).textContent = h + ""), e < h ? ((s.textContent = "NEW HIGH SCORE"), (this.storage.score = h)) : (s.textContent = "SCORE"), (this.storage.token += o), this.store(), (this.active = !0), (this.body.className = "end"));
      }
      show() {
  ...
  (function (t) {
    t.Platform = class extends T3D.Item {
      ...
      intersect(t, e = !1) {
        ...
        let s,
          i = this.fence;
        return (this.token.intersect(t), i.active && (s = i.collider.intersect(t.collider)) && (e && s.x && t.cancel(), t.transform.translate.add(s), (t.speed.y += s.y)), this.block.active ? ((s = this.block.collider.intersect(t.collider)) && (e && s.x && t.cancel(), t.transform.translate.add(s), (t.speed.y += s.y)), s) : void 0);
      }
    };
  })(Game || (Game = {})),
  (function (t) {
    t.Scene = class extends T3D.Item {
      ...
      next() {
        this.planet > 0 && ((this.planets.item(this.planet--).className = "hide"), t.Event.trigger("planet", this.planet));
      }
      ended() {
      ...
      updateRow(t) {
        ((this.row -= t), this.row <= -0.5 && (this.row += 11), (this.index = 3 * Math.round(this.row) + Math.round(this.hero.transform.translate.x) + 1));
      }
      getIndex(t = 0) {
      ...
      update() {
        ...
        (this.platforms.forEach((t, a) => {
          if (t.update(i)) {
            ((n += t.fence.active && s.transform.translate.y > -1 ? 1 : 0), (r += !t.enemy.active || t.enemy.stroke || s.stroke ? 0 : 1));
            let i = this.map.row[a % 3],
              o = i >> 2;
            ((t.block.active = (1 & i) > 0), (t.transform.translate.y = (2 & i) > 0 ? 0 : -1), t.token.init(1 == o || 4 == o), (t.fence.active = 2 == o), t.enemy.init(3 == o), (t.token.transform.rotate.y = 45), (e = !0));
          }
          t.enemy.intersect(s);
        }),
  ...
  (function (t) {
    const e = { coin: "Collect $ token", power: "Collect $ big token", planet: "Travel to $", fence: "Dodge junks $ time", enemy: "Dodge asteroids $ time", hit: "Destroy $ asteroid" },
    ...
    t.Task = class {
      ...
      toString() {
        ...
        return ("planet" == t ? (n = s[this.target - 1]) : (this.target > 1 && (i += "s"), this.run && (i += " on a mission"), !this.done && this.count && (n += " / " + this.count)), i.replace("$", n));
      }
    };
  })(Game || (Game = {})),
  (function (t) {
    ...
    t.Token = class extends T3D.Item {
      ...
      init(e) {
        ((this.active = e), this.transform.translate.set(0, 1, 0), (this.big = !t.Rand.get(50, 0, !0)), (this.speed = 0.01));
      }
      score() {
        return this.big ? 5 : 1;
      }
      update() {
        ...
        ((t.y = (t.y + 1.5) % 360), this.big ? (i.set(0.7, 0.15, 0.7), (this.color = s)) : (i.set(0.5, 0.1, 0.5), (this.color = e)));
      }
      intersect(t) {
        let e = this.big ? t.collider : t.tokenCollider;
        if (this.active && this.collider.intersect(e)) {
          let e = this.collider.getTranslate();
          if (e.distance(t.transform.translate) < 0.5) return ((this.active = !1), void (this.big ? t.magnetize() : t.coin()));
  ...
  (function (t) {
    ...
    ((i.seed = Math.random()), (t.Rand = i), (t.COLOR = { WHITE: [1, 1, 1, 10], PINK: [1, 0.3, 1, 30], BLUE: [0.3, 0.3, 1, 30], YELLOW: [1, 1, 0.3, 30], RED: [1, 0.3, 0.3, 0], CYAN: [0.3, 1, 1, 30] }));
    let n,
      r = !1,
      a = e("#game"),
      o = new t.Menu(),
      ...
      p = new t.Scene(
        ...
        () => {
          let e = new t.Platform(),
            ...
            i = new t.Enemy(d.enemy, t.COLOR.CYAN, [, 1, , , , , 0.7, 0.7, 0.7]),
            n = new t.Token(d.token, t.COLOR.YELLOW, [, 1, , 90, , , 0.5, 0.1, 0.5]),
            r = new T3D.Item(d.fence, t.COLOR.RED, [, 1.4, , , , , 0.8, 1, 0.8]);
          return ((s.collider = new T3D.Box(s.transform)), (i.collider = new T3D.Sphere(i.transform)), (n.collider = new T3D.Sphere(n.transform)), (r.collider = new T3D.Box(r.transform)), (e.block = s), (e.token = n), (e.fence = r), (e.enemy = i), e.add(s).add(n).add(r).add(i));
        },
    ...
    function g() {
      ((a.width = a.clientWidth), (a.height = a.clientHeight), (u.aspect = a.width / a.height), c.viewport(0, 0, a.width, a.height));
    }
    function v(t, e = 0) {
      if (
        (t.childs.forEach((t) => {
    ...
    function x() {
      if ((requestAnimationFrame(x), c.clear(c.COLOR_BUFFER_BIT), o.shop)) return ((f.mesh = d.hero[o.selected]), f.preview(), v(f), void v(f, 0.02));
      let t = new Date().getTime();
      if ((t - h > 30 && p.update(), (h = t), p.update(), v(p), v(p, 0.02), !f.active && n)) {
        let t = SFX.mixer("music"),
          e = t.context.currentTime;
        (t.gain.setValueCurveAtTime(Float32Array.from([o.volume, 0]), e, 0.5), n.stop(e + 0.5), (n = null));
      }
    ...
    async function w() {
      r = !0;
      let t = e("#start");
      ((t.className = "disabled"), (t.textContent = "loading"), await SFX.init(), await Promise.all([new SFX.Sound("custom", [5, 1, 0], 1).render("exp", [220, 0], 1), new SFX.Sound("custom", [3, 1, 0], 1).render("hit", [1760, 0], 0.3), new SFX.Sound("square", [0.5, 0.1, 0], 1).render("power", [440, 880, 440, 880, 440, 880, 440, 880], 0.3), new SFX.Sound("triangle", [0.5, 0.1, 0], 1).render("jump", [220, 880], 0.3), new SFX.Sound("square", [0.2, 0.1, 0], 0.2).render("coin", [1760, 1760], 0.2), new SFX.Sound("custom", [0.1, 0.5, 0], 0.3).render("move", [1760, 440], 0.3), SFX.render("music", [new SFX.Channel(new SFX.Sound("sawtooth", [1, 0.3], 0.2), "8a2,8a2,8b2,8c3|8|8g2,8g2,8a2,8b2|8|8e2,8e2,8f2,8g2|4|8g2,8g2,8a2,8b2|4|".repeat(4), 1), new SFX.Channel(new SFX.Sound("sawtooth", [0.5, 0.5], 1), "1a3,1g3,2e3,4b3,4c4,1a3c3e3,1g3b3d4,2e3g3b3,4d3g3b3,4g3c4e4|1|" + "8a3,8a3e4,8a3d4,8a3e4|2|8g3,8g3d4,8g3c4,8g3d4|2|8e3,8e3a3,8e3b3,8e3a3,4g3b3,4g3c4|1|".repeat(2), 4)])]), (e("#load").className = "hide"), x());
    }
    (s(window, "load", async () => {
      (f.init(),
          ...
          (s(document, "touchstart", (t) => {
            ...
            s(
              ...
              (t) => {
                ...
                let e = t.touches[0];
                !h[39] && e.clientX - i > 15 ? ((h[39] = !0), p.input(39), (c = !1)) : !h[37] && e.clientX - i < -15 ? ((h[37] = !0), p.input(37), (c = !1)) : !h[40] && e.clientY - a > 15 ? ((h[40] = !0), p.input(40), (c = !1)) : !h[38] && e.clientY - a < -15 && ((h[38] = !0), p.input(38), (c = !1));
              },
              { passive: !1 },
            ),
            s(document, "touchend", (t) => {
              (c && !o.active && ((h[32] = !0), p.input(32)), (h[32] = h[37] = h[38] = h[39] = h[40] = c = !1));
            }),
            ...
            t.Event.on("start", () => {
              if ((o.hide(), p.init(), !n)) {
                let t = SFX.mixer("music"),
                  e = t.context.currentTime;
                (t.gain.setValueAtTime(o.volume, e), (n = SFX.play("music", !0, "music")));
              }
            }),
            t.Event.on("end", () => {
              (f.init(!1), o.show());
